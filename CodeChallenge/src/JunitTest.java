...
String TestDataFilesPath ="C:\\Users\\"+System.getenv("USERNAME")+"\\Desktop\\CodeChallenge\\TestDataFiles\\";
...
//Test1- Longest Words is at the begining of the file
	...
	String logestword = TransposeLongestWord.longestWord(TestDataFilesPath+"Test1.txt");
...
//Test2- Longest Word is at the middle of the file
	...
	String logestword = TransposeLongestWord.longestWord(TestDataFilesPath+"Test2.txt");
	String transposeword =TransposeLongestWord.TransposeWord(logestword);
	assertEquals("abcde",logestword);	
	assertEquals("edcba",transposeword);
	}
...
//Test3- Longest Word is at the End of the file
	...
	String logestword = TransposeLongestWord.longestWord(TestDataFilesPath+"Test3.txt");
	String transposeword =TransposeLongestWord.TransposeWord(logestword);
	assertEquals("abcde",logestword);
	assertEquals("edcba",transposeword);
	}
...
//Test4- Longest Word is in numeric format
	...
	String logestword = TransposeLongestWord.longestWord(TestDataFilesPath +"Test4.txt");
	String transposeword =TransposeLongestWord.TransposeWord(logestword);
...
//Test5- Longest Word is in AlphaNumeric format
	...
	String logestword = TransposeLongestWord.longestWord(TestDataFilesPath +"Test5.txt");
	String transposeword =TransposeLongestWord.TransposeWord(logestword);
...
//Test6- Longest Word is in with special chars format
	...
	String logestword = TransposeLongestWord.longestWord(TestDataFilesPath +"Test6.txt");
	String transposeword =TransposeLongestWord.TransposeWord(logestword);
	assertEquals("abcde$%",logestword);	
	assertEquals("%$edcba",transposeword);
	}
...
//Test7- Invalid File type	
	...
	public void testInvalidfileformat() throws FileNotFoundException {	
		...
		String logestword = TransposeLongestWord.longestWord(TestDataFilesPath +"Test1.xls");
...
//Test8- Given File not found
	...
	public void testfilenotfound() throws FileNotFoundException {	
		...
		String logestword = TransposeLongestWord.longestWord(TestDataFilesPath +"Test9.txt");
...
//Test9- Empty File No Data or Spaces
	...
	public void testEmptyfile() throws FileNotFoundException {	
		...
		String logestword = TransposeLongestWord.longestWord(TestDataFilesPath +"Emptyfile.txt");
